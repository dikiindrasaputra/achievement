...
<h1 class="text-2xl font-bold text-gray-800">Achievement Tracker <br> Singkut Hub</h1>
    ...
    <?php if($errors->any()): ?>
        <div class="mb-6 flex items-center gap-3 p-4 bg-red-50 border border-red-200 rounded-xl">
            ...
            <span class="text-sm text-red-600"><?php echo e($errors->first('email')); ?></span>
        </div>
    <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/dikii/kerja/achievement/achievement/resources/views/auth/login.blade.php ENDPATH**/ ?>